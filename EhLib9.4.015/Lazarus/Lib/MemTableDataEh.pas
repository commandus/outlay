...
begin
  ...
  begin
    //Treat self-reference node as root node
    Exit;
  end;
  Result := True;
    ...
    rlnRecAddingEh:
      begin
        ...
        begin
          ...
          if KeyFound then
            raise EUnicalKeyViolationEh.Create('Unique key violation ' + sLineBreak +
...
procedure TMTIndexEh.CheckUnical;
var
  v: Variant;
  i: Integer;
begin
